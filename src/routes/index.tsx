...
import { LoadingScreen } from "@/components/memento/LoadingScreen";
import { CursorTrail } from "@/components/memento/CursorTrail";
            ...
            <main>
              ...
              <footer className="mx-auto mt-12 max-w-6xl border-t border-border px-4 py-8 text-center">
                ...
                <p className="mx-auto mt-6 max-w-2xl text-[11px] leading-relaxed text-muted-foreground sm:text-xs">
                  ...
                  anotações e marcações do calendário são salvas exclusivamente no LocalStorage do
                  seu próprio navegador. Não possuímos servidores nem banco de dados conectado.
                  Limpar os dados ou formatar o seu navegador apagará permanentemente os seus
                  registros.
                </p>
              </footer>
              ...
              <section className="mx-auto mt-16 max-w-4xl border-t border-border px-4 py-12">
                <div className="mx-auto max-w-3xl text-center">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                    ...
                    espaço que ainda resta, você ganha um choque de realidade contra a
                    procrastinação e o piloto automático.
                  </p>
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                    Para ajudar você a extrair o máximo do seu tempo presente (Carpe Diem),
                    combinamos a reflexão filosófica com ferramentas modernas de organização:
                  </p>
                  <ul className="mt-4 space-y-2 text-left text-sm leading-relaxed text-muted-foreground">
                    <li>
                      <strong className="text-foreground/80">Calendário Interativo:</strong> Um
                      ritual semanal para você marcar, de forma consciente, a semana que se
                      encerrou.
                    </li>
                    <li>
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                    ...
                    exclusivamente no armazenamento interno do seu próprio navegador. Seu progresso
                    e suas reflexões pertencem estritamente a você.
                  </p>
              ...
              <section className="mx-auto mt-8 max-w-4xl border-t border-border px-4 py-12 text-center">
                ...
                <p className="mt-4 max-w-lg mx-auto text-sm leading-relaxed text-muted-foreground">
                  Quer transformar sua ideia em realidade ou entrar em contato? Inicie uma conexão
                  segura com o desenvolvedor.
                </p>
              ...
              <section className="mx-auto mt-2 max-w-4xl border-t border-border px-4 py-12 text-center">
                ...
                <p className="mt-4 max-w-lg mx-auto text-sm leading-relaxed text-muted-foreground">
                  Este site funciona 100% offline, salvando seus dados localmente no navegador, e
                  pode ser instalado como um aplicativo no seu celular ou computador para acesso
                  rápido.
                </p>
                <div className="mt-6 flex flex-col items-center justify-center gap-3">
                  {deferredPrompt ? (
                    ...
                    <p className="text-xs text-muted-foreground/80 italic max-w-md">
                      Para instalar, abra o menu do seu navegador (como Chrome ou Safari) e
                      selecione &quot;Instalar&quot; ou &quot;Adicionar à tela de início&quot;.
                    </p>
                  )}
                </div>
              </section>
              ...
              {/* Créditos da Música */}
              <section className="mx-auto mt-8 max-w-4xl border-t border-border px-4 py-10 text-center">
                <h2 className="font-serif text-lg italic tracking-wide text-foreground/70">
                  Música de Fundo
                </h2>
                <p className="mt-3 text-xs leading-relaxed text-muted-foreground">
                  &ldquo;you&rsquo;re not the same, on a wintry day&rdquo; por{" "}
                  <span className="font-medium text-foreground/60">tilekid</span> · Adaptação:{" "}
                  <span className="font-medium text-foreground/60">Moliv</span>
                </p>
                <a
                  href="https://www.youtube.com/watch?v=Did7HDlezO0"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 inline-block text-[11px] text-muted-foreground/60 hover:text-foreground/80 underline underline-offset-2 transition-colors"
                >
                  Ouvir original no YouTube →
                </a>
                <p className="mt-6 text-xs italic text-muted-foreground/50">
                  Para uma experiência mais completa, acesse este site pelo computador.
                </p>
              </section>
            </main>
          </div>
