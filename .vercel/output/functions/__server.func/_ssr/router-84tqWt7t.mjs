...
const $$splitComponentImporter = () => import("./index-CTIgbJ8F.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Visualize sua vida em semanas, organize tarefas e anotações. Um dashboard estoico minimalista."
    }, {
      property: "og:title",
      content: "Memento Mori Dashboard"
    }, {
